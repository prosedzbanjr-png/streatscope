...
export async function GET() {
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ position: "relative", marginTop: -36, width: 1040, display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <div style={{ marginTop: 34, display: "flex", alignItems: "center", justifyContent: "center", padding: "11px 22px", border: "2px solid #a90d13", borderRadius: 10, background: "rgba(5,5,5,.72)", fontSize: 24, fontWeight: 600, letterSpacing: "1px", color: "#f3f3f1" }}>
          https://streetscope.vercel.app
        </div>
      </div>
