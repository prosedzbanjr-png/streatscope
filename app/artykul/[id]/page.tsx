...
import { optimizedImageUrl, optimizeArticleHtmlImages } from "../../../lib/image-optimization";
import "./article.css";
...
export default function ArticlePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const safeBody = optimizeArticleHtmlImages(ensureArticle24Paragraph(removeRepeatedRedlineParagraphs(toReaderArticleHtml(rawBody)), article.id), 1200);
