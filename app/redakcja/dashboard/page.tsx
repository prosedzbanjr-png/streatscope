...
export default function DashboardPage(){
  ...
  return <main className="chief-dashboard">
    <header><a href="/" className="wordmark">STREET<span>SCOPE</span></a><nav><a href="/redakcja/materialy">MATERIAŁY</a><a href="/redakcja/material">EDYTOR</a><a href="/redakcja/kultura">FASHION / MOTOR</a><a href="/redakcja/market">SCOPE MARKET</a><a href="/redakcja/guide">SCOPE GUIDE</a>{isChief&&<><a href="/redakcja/zarzadzaj">ZARZĄDZAJ</a><a href="/redakcja/logi">LOGI</a></>}</nav></header>
    ...
    <section className="dashboard-cards">
      ...
      <a href="/redakcja/market"><span>SCOPE MARKET</span><b>T&T</b><em>WYSTAW AUTO · EDYTUJ · SOLD →</em></a>
