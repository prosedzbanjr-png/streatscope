...
export default function DashboardPage(){
  ...
  return <main className="chief-dashboard">
    <header><a href="/" className="wordmark">STREET<span>SCOPE</span></a><nav><a href="/redakcja/material">EDYTOR</a><a href="/redakcja/zarzadzaj">ZARZĄDZAJ</a><a href="/redakcja/guide">SCOPE GUIDE</a><a href="/redakcja/logi">LOGI</a></nav></header>
