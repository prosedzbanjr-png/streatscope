...
export default function MaterialPage() {
  ...
  async function save(event: FormEvent, status: "draft" | "published") {
    ...
    try {
      ...
      const payload = { title: title.trim(), excerpt: excerpt.trim(), category, body, image_url: image_url || existingCover, gallery: [], social_title: socialTitle.trim() || null, social_description: socialDescription.trim() || null, social_image: socialImage.trim() || null, status, author_email: EDITOR_EMAIL, published_at: status === "published" ? new Date().toISOString() : null, updated_at: new Date().toISOString() };
