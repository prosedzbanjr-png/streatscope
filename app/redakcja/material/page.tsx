...
export default function MaterialPage() {
  ...
  const [allowed, setAllowed] = useState<boolean | null>(null); const [role, setRole] = useState<"chief" | "editor" | null>(null); const [currentEmail, setCurrentEmail] = useState(""); const [articleAuthor, setArticleAuthor] = useState("");
  ...
  async function save(event: FormEvent, action: "draft" | "review" | "published") {
    ...
    if (action === "published" && role !== "chief") { setMessage("Materiał może opublikować tylko naczelny. Wyślij go do akceptacji."); return; }
