...
export default function Home() {
  ...
  return <main>
    ...
    <header className="nav"><a href="#top" className="wordmark">STREET<span>SCOPE</span></a><nav><a href="#stories">WIADOMOŚCI</a><a href="#city">MIASTO</a><a href="#about">O REDAKCJI</a></nav><a className="report" href="/redakcja">PANEL REDAKCJI <b>↗</b></a></header>
